            ...
            <tr>
                ...
                <td valign="top" background="/Public/images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="/Public/images/content_bg.gif">
                        <tr><td height="31"><div class="title">字段列表</div></td></tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td valign="top" bgcolor="#F7F8F9">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                            ...
                            <td colspan="4">
                                <table>
                                    <tr>
                                        ...
                                        <td valign="bottom"><h3 style="letter-spacing:1px;">在这里，您可以根据您的需求，填写网站参数！<input type="button" value="添加字段" onclick="window.location.href='/index.php/Home/ModelField/add/id/<?php echo $_GET['id']?>'"/></h3></td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
                                        ...
                                        <td colspan="2">
                                            <form action="" method="">
                                                <table width="100%"  class="cont tr_color">
                                                    ...
                                                    <?php foreach($fielddata as $v){?>
                                                    <tr align="center" class="d">
                                                        <td><?php echo $v['id']?></td>                                                     
                                                        <td><?php echo $v['field_cnname']?></td>                                                
                                                        <td><?php echo $v['field_enname']?></td>                                                
                                                        <td><?php echo $v['field_type']?></td>                                                
                                                        <td><?php echo $v['field_value']?></td>                                                
                                                        <td><a href="/index.php/Home/ModelField/del/id/<?php echo $v['id']?>">删除</a></td>
                                                    </tr>
                                                   <?php }?>
                                                </table>
                                            </form>
                        ...
                        <tr>
                            <td colspan="2" align="center"><?php echo $showpage;?></td>                        
                        </tr>
                        <!-- 添加栏目结束 -->
                        <tr>
                            <td height="40" colspan="4">
