...
<head>
    ...
    <body>
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
            ...
            <tr>
                ...
                <td valign="top" background="/Public/Images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="././Images/content_bg.gif">
                        <tr><td height="31"><div class="title">内容列表</div></td></tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td valign="top" bgcolor="#F7F8F9">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                        	<td width="2%">&nbsp;</td>
                        	<td><input onclick="location.href='/index.php/Home/Content/add/model_id/<?php echo $_GET['id']; ?>';" type="button" value="添加内容" /></td>
                        </tr>
                        <tr>
                            <td width="2%">&nbsp;</td>
                            <td width="96%">
          ...
          <?php foreach ($archdata as $m): ?>                                          
                                                    <tr align="center" class="d">
                                                        <td><input type="checkbox" value="<?php echo $m['id']; ?>" /></td>
                                                        <td><?php echo $m['id']; ?></td>
                                                        <td><?php echo $m['title']; ?></td>
                                                        <td><img src="/Public/<?php echo $m['itpic'];?>" width="50" height="50"/></td>
                                                        
                                                        <td><a href="/index.php/Home/Content/edit/id/<?php echo $m['id']; ?>/mid/<?php echo $m['model_id']; ?>">修改</a> | <a onclick="return confirm('确定要删除吗？');" href="/index.php/Home/Content/del/id/<?php echo $m['id']; ?>">删除</a></td>
                                                    </tr>
          <?php endforeach; ?>
                                                </table>
                                            </form>
