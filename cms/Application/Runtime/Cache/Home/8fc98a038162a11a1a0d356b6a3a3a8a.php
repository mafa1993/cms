                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="/index.php/Home/Privilege/edit/id/8/p/" method="POST">
                                            <!-- 表单中必须要有这个隐藏来存修改的记录的ID，这个字段必须是主键 -->
                                            	<!--input type="hidden" name="id" value="<?php echo $info['id']; ?>" /-->
                                                <table width="100%" class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>角色名称：</td>
                                                        <td><input class="text" type="text" name="username" value="<?php echo $username; ?>" /></td>
                                                        <td>&nbsp;</td>
                                                        <td width="2%">&nbsp;</td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>选择权限：</td>
                                                        <td>
<?php  foreach ($pri as $k => $v): if(in_array($k, $_pri)) $checked = ' checked="checked" '; else $checked = ''; ?>
<label><input <?php echo $checked; ?> type="checkbox" name="action_list[]" value="<?php echo $k; ?>" />
<?php echo $v; ?>
