            ...
            <tr>
                ...
                <td valign="top" background="/Public/images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="/Public/images/content_bg.gif">
                        <tr><td height="31"><div class="title">模型列表</div></td></tr>
                    </table>
                </td>
            ...
            <tr>
                ...
                <td valign="top" bgcolor="#F7F8F9">
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                                        ...
                                        <td colspan="2">
                                            <form action="" method="">
                                                <table width="100%"  class="cont tr_color">
                                                    ...
                                                    <?php $i=1; foreach($modeldata as $v){?>
                                                    <tr align="center" class="d">
                                                        <td><?php echo $i; $i++;?></td>                                                     
                                                        <td><?php echo $v['model_name']?></td>                                                
                                                        <td><?php echo $v['table_name']?></td>                                                
                                                        <td><a href="/index.php/Home/ModelField/lst/id/<?php echo $v['id']?>">字段列表</a> | <a href="/index.php/Home/Model/edit/id/<?php echo $v['id']?>">编辑</a> <a href="/index.php/Home/Model/del/id/<?php echo $v['id']?>"> 删除</a></td>
                                                    </tr>
                                                   <?php }?>
                                                </table>
                                            </form>
                        ...
                        <tr ><td colspan="4" align="right" ><a href="add" > 添加模型 &nbsp;&nbsp;&nbsp;</a></td></tr>
                        <!-- 添加栏目结束 -->
                        <tr>
                            <td height="40" colspan="2">
                                <table width="100%" height="1" border="0" cellpadding="0" cellspacing="0" bgcolor="#CCCCCC">
                                    <tr><td align='center'><?php echo $showpage;?></td></tr>
                                </table>
                            </td>
