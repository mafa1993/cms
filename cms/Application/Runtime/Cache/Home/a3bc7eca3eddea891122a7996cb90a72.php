            ...
            <tr>
                ...
                <td valign="top" background="/Public/images/content_bg.gif">
                    <table width="100%" height="31" border="0" cellpadding="0" cellspacing="0" background="/Public/images/content_bg.gif">
                        <tr><td height="31"><div class="title">修改模型</div></td></tr>
                    </table>
                </td>
                        ...
                        <tr>
                            ...
                            <td width="96%">
                                <table width="100%">
                                    <tr>
                                        <td colspan="2">
                                            <form action="/index.php/Home/Model/edit" method="post">
                                            <input type="hidden" name="id" value="<?php echo $modeldata['id'];?>" />
                                                <table width="100%" class="cont">
                                                    <tr>
                                                        <td width="2%">&nbsp;</td>
                                                        <td>模型名称：</td>
                                                        <td width="80%"><input class="text" type="text" name="model_name" value="<?php echo $modeldata['model_name']; ?>" /></td>                                                       
                                                    </tr>
                                                    <tr>
                                                        <td>&nbsp;</td>
                                                        <td>附加表名：</td>
                                                        <td>
                                                           <input class="text" type="text" name="table_name" value="<?php echo $modeldata['table_name'] ?>" />
                                                        </td>
